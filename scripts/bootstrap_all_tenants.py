...
def bootstrap_all_tenants(base_url="http://localhost:8000", force=False, pending_only=False):
    """
...
def main():
    ...
    success = bootstrap_all_tenants(base_url=args.base_url, force=args.force, pending_only=args.pending_only)
