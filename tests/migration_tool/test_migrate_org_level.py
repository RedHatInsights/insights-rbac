...
class MigrateOrgLevelTests(TestCase):
    ...
    def test_migrate_dual_default(self):
        """Test that migrating a role that is both platform- and admin-default creates relations with both roles."""
    ...
    def test_migrate_mixed_scope(self):
        """Test that migrating roles with mixed permission scopes works correctly."""
    ...
    def test_remove_existing_relations(self, outbox_replicate):
        """Test that migrating roles with non-default scope appropriately"""
        ...
        # This configuration assign root_role to root workspace scope and tenant_role to tenant scope.
        self._do_migrate(
            resource_service=ImplicitResourceService(
