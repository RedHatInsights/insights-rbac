...
class RoleViewsetTests(IdentityRequest):
    ...
    @override_settings(REPLICATION_TO_RELATION_ENABLED=True, ROLE_CREATE_ALLOW_LIST="inventory,patch")
    @patch("management.relation_replicator.outbox_replicator.OutboxReplicator.replicate")
    ...
    @override_settings(REPLICATION_TO_RELATION_ENABLED=True, ROLE_CREATE_ALLOW_LIST="advisor,vulnerability")
    @patch("management.relation_replicator.outbox_replicator.OutboxReplicator.replicate")
    ...
    @override_settings(REPLICATION_TO_RELATION_ENABLED=True, ROLE_CREATE_ALLOW_LIST="rbac,cost-management")
    @patch("management.relation_replicator.outbox_replicator.OutboxReplicator.replicate")
    def test_role_with_tenant_scope_permissions_binds_to_tenant(self, replicate):
        ...
        self.assertEqual(
            resource_id, expected_tenant_id, f"Role should be bound to tenant {expected_tenant_id}, got {resource_id}"
        )

    @override_settings(REPLICATION_TO_RELATION_ENABLED=True, ROLE_CREATE_ALLOW_LIST="inventory,advisor,rbac")
    @patch("management.relation_replicator.outbox_replicator.OutboxReplicator.replicate")
