...
V2_ROLE_SEEDING_ENABLED = ENVIRONMENT.bool("V2_ROLE_SEEDING_ENABLED", default=True)
V2_ROLE_BINDING_SEEDING_ENABLED = ENVIRONMENT.bool("V2_ROLE_BINDING_SEEDING_ENABLED", default=True)
V2_ROLE_BINDING_GROUP_SEEDING_ENABLED = ENVIRONMENT.bool("V2_ROLE_BINDING_GROUP_SEEDING_ENABLED", default=True)
GROUP_SEEDING_ENABLED = ENVIRONMENT.bool("GROUP_SEEDING_ENABLED", default=True)
WORKSPACE_SEEDING_ENABLED = ENVIRONMENT.bool("WORKSPACE_SEEDING_ENABLED", default=True)
