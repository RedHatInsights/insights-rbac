...
# Permission scope configuration (wildcard patterns, e.g., "advisor:*:*, rbac:*:read")
# Used by management.permission_scope.ImplicitResourceService
...
# Policy UUIDs for additional default role bindings
