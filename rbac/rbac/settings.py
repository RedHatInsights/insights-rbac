...
NOTIFICATIONS_ENABLED = False # ENVIRONMENT.get_value("NOTIFICATIONS_ENABLED", default=False)
NOTIFICATIONS_RH_ENABLED = False #ENVIRONMENT.get_value("NOTIFICATIONS_RH_ENABLED", default=False)
