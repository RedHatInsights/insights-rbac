...
# Seeding Setup
PERMISSION_SEEDING_ENABLED = False #ENVIRONMENT.bool("PERMISSION_SEEDING_ENABLED", default=True)
ROLE_SEEDING_ENABLED = False #ENVIRONMENT.bool("ROLE_SEEDING_ENABLED", default=True)
GROUP_SEEDING_ENABLED = False #ENVIRONMENT.bool("GROUP_SEEDING_ENABLED", default=True)
