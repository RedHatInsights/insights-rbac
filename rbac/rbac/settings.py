...
# Application scope settings for permission binding
ROOT_SCOPE_APPS = ENVIRONMENT.get_value("ROOT_SCOPE_APPS", default="")
TENANT_SCOPE_APPS = ENVIRONMENT.get_value("TENANT_SCOPE_APPS", default="")
# Policy UUIDs for additional tenant bindings
ROOT_SCOPE_POLICY_UUID = ENVIRONMENT.get_value(
    "ROOT_SCOPE_POLICY_UUID", default="123e4567-e89b-12d3-a456-426614174001"
)
TENANT_SCOPE_POLICY_UUID = ENVIRONMENT.get_value(
    "TENANT_SCOPE_POLICY_UUID", default="123e4567-e89b-12d3-a456-426614174002"
)
ROOT_SCOPE_ADMIN_POLICY_UUID = ENVIRONMENT.get_value(
    "ROOT_SCOPE_ADMIN_POLICY_UUID", default="123e4567-e89b-12d3-a456-426614174003"
)
TENANT_SCOPE_ADMIN_POLICY_UUID = ENVIRONMENT.get_value(
    "TENANT_SCOPE_ADMIN_POLICY_UUID", default="123e4567-e89b-12d3-a456-426614174004"
)
