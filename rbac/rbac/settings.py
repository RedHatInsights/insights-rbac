...
V2_MIGRATION_APP_EXCLUDE_LIST = ENVIRONMENT.get_value("V2_MIGRATION_APP_EXCLUDE_LIST", default="")
V2_MIGRATION_RESOURCE_APP_EXCLUDE_LIST = ENVIRONMENT.get_value("V2_MIGRATION_RESOURCE_APP_EXCLUDE_LIST", default="")
