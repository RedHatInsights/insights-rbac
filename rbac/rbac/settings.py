...
SYSTEM_DEFAULT_ROOT_WORKSPACE_ROLE_UUID = ENVIRONMENT.get_value("SYSTEM_DEFAULT_ROOT_WORKSPACE_ROLE_UUID")
if not SYSTEM_DEFAULT_ROOT_WORKSPACE_ROLE_UUID:
    raise EnvironmentError("Missing required environment variable: SYSTEM_DEFAULT_ROOT_WORKSPACE_ROLE_UUID")

SYSTEM_DEFAULT_TENANT_ROLE_UUID = ENVIRONMENT.get_value("SYSTEM_DEFAULT_TENANT_ROLE_UUID")
if not SYSTEM_DEFAULT_TENANT_ROLE_UUID:
    raise EnvironmentError("Missing required environment variable: SYSTEM_DEFAULT_TENANT_ROLE_UUID")

SYSTEM_ADMIN_ROOT_WORKSPACE_ROLE_UUID = ENVIRONMENT.get_value("SYSTEM_ADMIN_ROOT_WORKSPACE_ROLE_UUID")
if not SYSTEM_ADMIN_ROOT_WORKSPACE_ROLE_UUID:
    raise EnvironmentError("Missing required environment variable: SYSTEM_ADMIN_ROOT_WORKSPACE_ROLE_UUID")

SYSTEM_ADMIN_TENANT_ROLE_UUID = ENVIRONMENT.get_value("SYSTEM_ADMIN_TENANT_ROLE_UUID")
if not SYSTEM_ADMIN_TENANT_ROLE_UUID:
    raise EnvironmentError("Missing required environment variable: SYSTEM_ADMIN_TENANT_ROLE_UUID")
