...
from management.api.v1.principal.serializers import PrincipalInputSerializer, PrincipalSerializer
from management.api.v1.role.serializers import RoleMinimumSerializer
